...
#
#SBATCH --verbose
#SBATCH --output=/mnt/beegfs/work/englaender/M2QA/m2qa/output/train_xlm_r/log_full.txt
...
/storage/ukp/work/englaender/miniconda/envs/plain_hf_transformers/bin/python run_qa.py \
  ...
  --max_seq_length 512 \
  --doc_stride 128 \
  --output_dir /storage/ukp/work/englaender/M2QA/m2qa/Experiments/Trained_model/fully-finetuned-xlm-r-final-thesis \
  --report_to wandb \
  --save_steps 1000 \
  --eval_steps 1000 \
  --logging_steps 1000 \
