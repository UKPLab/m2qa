...
#
#SBATCH --verbose
#SBATCH --output=/mnt/beegfs/work/englaender/M2QA/m2qa/output/train_domain_adapter/log_reviews_yelp.txt
...
/storage/ukp/work/englaender/miniconda/envs/plain_hf_transformers/bin/python run_mlm.py \
  ...
  --max_steps 100000 \
  --max_seq_length 512 \
  --output_dir /storage/ukp/work/englaender/M2QA/m2qa/Experiments/Trained_model/xlm-r-pretrained-reviews-yelp/ \
  --report_to wandb \
  --save_steps 25000 \
  --logging_steps 1000 \
  --warmup_steps 1000 \
